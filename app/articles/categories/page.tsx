...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "website",
      title: "Article Categories - Shikhar Gupta",
      description:
        "This page contains all the categories of articles available on this website.",
      url: `${server}/articles/categories`,
      siteName: "Shikhar Gupta - Innovative Researcher and Skilled Mentor",
      images: [
        {
          url: `${server}/images/og-image.png`,
          alt: "Shikhar Gupta - Innovative Researcher and Skilled Mentor",
          width: 1200,
          height: 630,
        },
      ],
